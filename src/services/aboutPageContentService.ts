...
const DEFAULT_ABOUT_CONTENT_DATA: Omit<AboutPageContent, 'id' | 'createdAt' | 'updatedAt'> = {
  ...
  missionImageUrl: 'https://placehold.co/700x500.png',
  missionImageAiHint: 'business strategy',
  ...
  visionImageUrl: 'https://placehold.co/700x500.png',
  visionImageAiHint: 'future tech',
...
function docToAboutPageContent(doc: IAboutPageContent | any): AboutPageContent {
  ...
  return {
    ...
    missionImageAiHint: plainDoc.missionImageAiHint || DEFAULT_ABOUT_CONTENT_DATA.missionImageAiHint,
    ...
    visionImageAiHint: plainDoc.visionImageAiHint || DEFAULT_ABOUT_CONTENT_DATA.visionImageAiHint,
