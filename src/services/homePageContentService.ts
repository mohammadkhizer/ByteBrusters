...
const DEFAULT_HOME_CONTENT_DATA: UpdateHomePageContentData = {
  ...
  whyByteBrustersImageUrl: 'https://placehold.co/800x600.png',
...
function docToHomePageContent(doc: IHomePageContent | any): HomePageContent {
  ...
  return {
    ...
    whyByteBrustersImageAiHint: plainDoc.whyByteBrustersImageAiHint || DEFAULT_HOME_CONTENT_DATA.whyByteBrustersImageAiHint,
